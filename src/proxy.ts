...
// /api/impresora = CloudPRNT: la térmica de cocina sondea con ?clave=IMPRESORA_SECRET.
const RUTAS_PUBLICAS = ["/login", "/api/salud", "/api/cron", "/api/webhooks", "/reservar", "/web", "/api/voz", "/api/impresora"];
